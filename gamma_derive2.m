function [f,gr,h] = gamma_derive2(x, yobs_tmp, chol_index, rho_temp, tau_temp_1,...
                    tau_temp_2, gamma_temp_1, gamma_temp_2, sigmasqalpha, nbasis, nseg)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Written on 07/04/2016 for the MCMC Non-Multi-spectrum analysis
% Function used for optimization process for those coeeficient is the same
% across segments
%
%   Input:
...
%
%   Required programs: lin_basis_func, gamma_derive1
yobs_tmp_1 = yobs_tmp(1:nseg,:);
yobs_tmp_2 = yobs_tmp(nseg+1:end,:);
[f1,grad1,hes1] = gamma_derive1(x, yobs_tmp_1, chol_index, rho_temp, tau_temp_1, gamma_temp_1, sigmasqalpha, nbasis);
[f2,grad2,hes2] = gamma_derive1(x, yobs_tmp_2, chol_index, rho_temp, tau_temp_2, gamma_temp_2, sigmasqalpha, nbasis);
